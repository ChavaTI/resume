...
\cvitem{VueJS}{I've developed Vue applications using tools as Vuex, boostrap-vue, UI vue tools.}
...
\cvitem{Neovim}{In order to improve my efficiency coding, I've started to write my code in this text editor.}
