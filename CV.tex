...
\cvitem{Ruby and Rails}{I've manteinig a project on Ruby and Rails coding API endpoints and unit test.}
...
\section{Tools}
\cvitem{Neovim}{In order to improve my efficiency coding, I write my code in this text editor.}
...
\cvitem{}{Working at JibJab I've created features and componets on the web app, working on the frontend, backend and manteinig AWS lambda functions.}
\cventry{2018--2021}{Web developer}{The Software Artisans}{}{}{}
\cvitem{}{Under thw period on TSA I've developed web solutions using differents tools for example NodeJS, Laravel, Angular, VueJS etc. and I've trained new people in TSA.}
